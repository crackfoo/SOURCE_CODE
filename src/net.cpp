...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "litecoinextreme " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ltcextreme.com", "nodea.ltcextreme.com"},
    {"ltcextreme.com", "nodeb.ltcextreme.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. litecoinextreme is probably already running."), addrBind.ToString().c_str());
        else
